...
_SCORE_FLOOR = 75  # below this, trade is rejected (aligned with pipeline score gate)
...
_MIN_ML_CONFIDENCE = 0.70  # below this, ML signal is too weak (CALLs)
_MIN_ML_CONFIDENCE_PUT = 0.65  # PUT model validated at 0.65 threshold (AUC 0.8038)
